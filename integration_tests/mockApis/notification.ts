...
export default {
  getSmsNotifications(): SuperAgentRequest {
    return stubFor({
      request: {
      ...
      response: {
        ...
        jsonBody: {
          links: {
            current: 'http://localhost:9091/notifications-api/v2/notifications?template_type=sms',
          },
          notifications: [
            {
  ...
  getNotification0001(): SuperAgentRequest {
    return stubFor({
      request: {
  ...
  getSmsNotificationsForA000001OlderThan0001(): SuperAgentRequest {
    return stubFor({
      request: {
      ...
      response: {
        ...
        jsonBody: {
          links: {
            current:
              'http://localhost:9090/notifications-api/v2/notifications?template_type=sms&reference=A000001&older_than=00000000-0000-0000-0000-000000000001',
          },
          notifications: [
            {
              body: "Dear test,\nYou have an appointment at Birmingham office on {{ now offset='-5 days' format='dd/MM/yyyy' }} at 5pm.\nThis is an automated message. Do not reply.",
            ...
            {
              body: "Dear test,\nYou have an appointment at Birmingham office on {{ now offset='-12 days' format='dd/MM/yyyy' }} at 5pm.\nThis is an automated message. Do not reply.",
  ...
  getTemplate0000(): SuperAgentRequest {
    return stubFor({
      request: {
